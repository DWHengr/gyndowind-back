...
public class GlobalExceptionHandler {
     ...
     * 自定义异常
     */
    @ExceptionHandler(value = com.dwh.gyndowindback.exception.GyndowindException.class)
    public Object TfiipException(GyndowindException e, HttpServletRequest request) {
